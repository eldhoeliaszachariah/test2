...
make install
Step 6: Install sampark-hin-lbm system(follow similar steps for hin2mehra and telugu2relli system installation)

Extract sampark-hin-lbm-0.1.tgz tar -xvzf sampark-hin-lbm-0.1.tgz
...
Inside the editor change the system name as your home directory. Example:

$setu=/home/trmt/sampark to

$setu=/home/calnic/sampark
...
perl /usr/share/Dashboard/source/dash.pl -c /home/calnic/sampark/bin/sys/hin_tel/hin_tel_setu.spec -i /home/calnic/sampark/bin/sl/morph/hin/tests/morph1.rin -l debug.log -o /home/calnic/OUTPUT.tmp
